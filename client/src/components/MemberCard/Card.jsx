...
const Card = (props) => {
  ...
  return (
    ...
    <div className="max-w-md mx-auto md:max-w-2xl sm:mt-6 min-w-md bg-white w-full mb-6 shadow-lg rounded-xl lg:mt-24">
    <div className="px-6">
        <div className="flex flex-wrap justify-center align-center">
            <div className="w-full flex justify-center align-center">
                <div className="relative">
                    <img src="" className="shadow-lg rounded-full align-middle relative -m-16 -ml-2 lg:-ml-16 max-w-[150px]"/>
                </div>
            </div>
        </div>
