        ...
        <div className="relative px-6">
            ...
            <div className="text-center mt-24">
                ...
                <div className="text-s mt-0 mb-2 text-slate-400 font-bold">
                    ...
                    <h3>Belongs to {props.infoMl} , {props.infoApi} , {props.infoReact} and {props.infoTeamLead}</h3>
      ...
      <div className="max-w-md mx-auto md:max-w-2xl sm:mt-6 min-w-md bg-white w-full mb-6 shadow-lg rounded-xl lg:mt-24 flex flex-col justify-between">
          <div className="relative px-6">
              ...
              <div className="text-center mt-24">
                  ...
                  <div className="text-s mt-0 mb-2 text-slate-400 font-bold">
                      <i className="fas fa-map-marker-alt mr-2 text-slate-500 opacity-75">{props.data.year}</i>
                      <h3>Belongs to {props.infoApi}</h3>
      ...
      <div className="max-w-md mx-auto md:max-w-2xl sm:mt-6 min-w-md bg-white w-full mb-6 shadow-lg rounded-xl lg:mt-24 flex flex-col justify-between">
          <div className="relative px-6">
              ...
              <div className="text-center mt-24">
                  ...
                  <div className="text-s mt-0 mb-2 text-slate-400 font-bold">
                      <i className="fas fa-map-marker-alt mr-2 text-slate-500 opacity-75">{props.data.year}</i>
                      <h3>Belongs to {props.infoReact}</h3>
      ...
      <div className="max-w-md mx-auto md:max-w-2xl sm:mt-6 min-w-md bg-white w-full mb-6 shadow-lg rounded-xl lg:mt-24 flex flex-col justify-between">
          <div className="relative px-6">
              ...
              <div className="text-center mt-24">
                  ...
                  <div className="text-s mt-0 mb-2 text-slate-400 font-bold">
                      <i className="fas fa-map-marker-alt mr-2 text-slate-500 opacity-75">{props.data.year}</i>
                      <h3>Belongs to {props.infoApi} and {props.infoMl}</h3>
...
if(props.isMlTeam && props.isTeamLead){
    return (
      <div className="max-w-md mx-auto md:max-w-2xl sm:mt-6 min-w-md bg-white w-full mb-6 shadow-lg rounded-xl lg:mt-24 flex flex-col justify-between">
          <div className="relative px-6">
              <div className="flex flex-wrap justify-center align-center">
              ...
              <div className="text-center mt-24">
                  ...
                  <div className="text-s mt-0 mb-2 text-slate-400 font-bold">
                      <i className="fas fa-map-marker-alt mr-2 text-slate-500 opacity-75">{props.data.year}</i>
                      <h3>Belongs to {props.infoApi} and {props.isTeamLead}</h3>
